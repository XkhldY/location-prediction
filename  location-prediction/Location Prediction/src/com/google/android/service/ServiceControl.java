...
public class ServiceControl {
	   ...
	   */
	  public static boolean isRecording(Context context, IRouteRecordingService service, SharedPreferences preferences) {
	    if (service != null) {
	      try 
	      {
	    ...
	    return preferences.getLong(context.getString(R.string.recording_route_key), -1) > 0;
	  }

	  /**
	   * Checks whether the recording service is currently running.
	   *
	   * @param ctx the current context - advisable to use getApplicationContext
